...
#### Package Manager:
```ps
Install-Package Excubo.Blazor.Canvas -Version 1.1.1
```

#### .NET Cli:
```cmd
dotnet add package Excubo.Blazor.Canvas --version 1.1.1
```

#### Package Reference
```xml
<PackageReference Include="Excubo.Blazor.Canvas" Version="1.1.1" />
```
