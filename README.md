...
#### Package Manager:
```ps
Install-Package Excubo.Blazor.Canvas -Version 0.8.0
```

#### .NET Cli:
```cmd
dotnet add package Excubo.Blazor.Canvas --version 0.8.0
```

#### Package Reference
```xml
<PackageReference Include="Excubo.Blazor.Canvas" Version="0.8.0" />
```
